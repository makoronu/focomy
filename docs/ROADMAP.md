...
| # | タスク | 状態 |
|---|--------|------|
| A1 | バージョン0.1.56未反映の原因調査 | 未着手 |
| - | Fly.ioビルド確認、キャッシュ確認 | 未着手 |

### S1: エディタ機能

**ファイル**: `core/templates/admin/editor.html`

| # | タスク | 状態 |
|---|--------|------|
| A3 | Visual/JSON切替修正 | 未着手 |
| A4 | 見出しH1-H4階層修正 | 未着手 |
| A5 | プレビュー機能修正 | 未着手 |
| B2 | プレビュー別タブで開く | 未着手 |
...
| # | タスク | 状態 |
|---|--------|------|
| D1 | postsチャンネル固定（削除不可） | 未着手 |
| D2 | 未指定記事→posts自動割当 | 未着手 |
| D3 | チャンネル間移動自由 | 未着手 |
