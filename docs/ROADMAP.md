...
| # | タスク | ファイル | 状態 |
|---|--------|----------|------|
| A3 | OGPメタデータAPI | `admin/routes.py` | 未着手 |
| B5 | OGPプレビューパネルUI | `entity_form.html` | 未着手 |
| D3 | OGPカードスタイル | `entity_form.html` | 未着手 |
| - | OGP更新関数 | `editor.html` | 未着手 |

**テスト**: タイトル・説明変更でSNSカード更新
