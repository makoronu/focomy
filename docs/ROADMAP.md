...
| # | タスク | 状態 |
|---|--------|------|
| 11 | embed変換（YouTube等） | 未着手 |
| 12 | freeform（クラシック）変換 | 未着手 |
| 13 | 未知ブロック→raw変換 | 未着手 |
| 14 | ネストブロック→フラット化 | 未着手 |
...
| # | タスク | 状態 |
|---|--------|------|
| 15 | Gutenbergなし検出 | 未着手 |
| 16 | BeautifulSoupでHTMLパース | 未着手 |
| 17 | HTML→ブロック変換 | 未着手 |

**人作業**: 素HTMLからの変換確認
**デバッグ**: Gutenberg/クラシック両方対応確認

### S5: インポーターへ統合

| # | タスク | 状態 |
|---|--------|------|
| 18 | importer.pyで変換器呼び出し | 未着手 |
| 19 | content→body(blocks)に変換 | 未着手 |
